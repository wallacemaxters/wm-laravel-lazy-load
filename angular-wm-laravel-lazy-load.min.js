...
if(c>=0){return this.data.splice(c,1);}};a.prototype.untilCompleted=function(){var c=this;c.next().then(function(){c.untilCompleted();});};a.prototype.next=function(){var c,d;
